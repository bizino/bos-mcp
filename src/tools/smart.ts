...
export const smartTools: McpTool[] = [
  {
    ...
    handler: async (args, client) => client.get('/smart/orders/summary', { params: args }),
  },
  {
    ...
    handler: async (args, client) => client.get('/smart/products/top', { params: args }),
  },
  {
    ...
    handler: async (args, client) => client.get('/smart/orders/cycle-time', { params: args }),
  },
  {
    ...
    schema: {},
    handler: async (_, client) => client.get('/smart/customers/segments'),
  },
  {
    ...
    handler: async (args, client) => client.get('/smart/inventory/health', { params: args }),
  },
  {
    ...
    handler: async (args, client) => client.get('/smart/inventory/reorder-plan', { params: args }),
  },
  {
    ...
    schema: {},
    handler: async (_, client) => client.get('/smart/inventory/imbalance'),
  }
];
