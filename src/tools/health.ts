...
export const healthTools: McpTool[] = [
  {
    ...
    schema: {},
    handler: async (_, client) => client.get('/api/boscli/health'),
  },
  {
    name: 'boscli_health_modules',
    description: 'Check health of all BOS modules',
    schema: {},
    handler: async (_, client) => client.get('/api/boscli/health/modules'),
  },
  {
    name: 'boscli_health_database',
    description: 'Check BOS database connectivity',
    schema: {},
    handler: async (_, client) => client.get('/api/boscli/health/database'),
  },
  {
    name: 'boscli_health_cache',
    description: 'Check BOS cache systems',
    schema: {},
    handler: async (_, client) => client.get('/api/boscli/health/cache'),
  },
  {
    name: 'boscli_health_schema',
    description: 'Check BOS database schema integrity',
    schema: {},
    handler: async (_, client) => client.get('/api/boscli/health/schema'),
  },
];
